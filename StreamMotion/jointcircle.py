...
jnt_motion1_acc = np.linspace(start = 0, stop = 22.5, num = 1000)
jnt_motion1_acc = jnt_motion1_acc * (1/100)

jnt_motion1_dec = np.linspace(start = 22.5, stop = 0, num = 1000)
jnt_motion1_dec = jnt_motion1_dec * (1/100)
    #negative increment from end to end
jnt_motion2_acc = np.linspace(start = 0, stop = 45, num = 2000)
jnt_motion2_acc = jnt_motion2_acc * (1/200)

jnt_motion2_dec = np.linspace(start = 45, stop = 0, num = 2000)
jnt_motion2_dec = jnt_motion2_dec * (1/200)
...
jnt_up_acc = np.linspace(start = 0, stop = 45, num = 2000) #0 -> 90
jnt_up_acc = jnt_up_acc * (1/400)

jnt_up_dec = np.linspace(start = 45, stop = 0, num = 2000)  #90-> 180
jnt_up_dec = jnt_up_dec * (1/400)
